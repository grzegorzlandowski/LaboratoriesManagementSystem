...
<div id="bodycontainer" class="container rounded">
    <h1 class="text-center" style="color: #FFE8E8">Dodaj nowe zgłoszenie</h1>
        ...
        <form:form id="form1" name="form1" modelAttribute="reportsystem" method="POST" action="/zapiszzgloszenie/${laboratoryid}" class="rounded p-4 p-sm-3">
            ...
            <div class="mb-3">
                ...
                <form:select  path="type" class="form-control">
                    <form:option value="fault">Awaria/Usterka</form:option>
                    <form:option value="request">Zapotrzebowanie/Braki</form:option>
                </form:select>
            </div>
            <div class="mb-3">
            ...
            <div class="d-flex justify-content-center"><button class="btn btn-primary" type="submit">Dodaj Zgłoszenie</button></div>
        </form:form>
    </div>
</div>
</div>
