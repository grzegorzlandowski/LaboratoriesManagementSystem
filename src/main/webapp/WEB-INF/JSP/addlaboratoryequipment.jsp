...
<div id="bodycontainer" class="container rounded">
    ...
    <div class="bodycontainer" class="container rounded">
        <form:form id="form1" name="form1" modelAttribute="laboratoryequipment" method="POST" action="/zapiszwyposazenie/${laboratoryid}" class="rounded p-4 p-sm-3">
            <div class="mb-3">
            ...
            <form:form id="form1" name="form1" modelAttribute="equipmentdetails" method="POST" action="/zapiszwyposazenie/${laboratoryid}" class="rounded p-4 p-sm-3">
                <div class="mb-3">
