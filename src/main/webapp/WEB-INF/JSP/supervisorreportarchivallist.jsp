...
<head>
    <title>Zgłoszenia od użytkowników - archiwalne</title>
...
<div id="bodycontainer" class="container rounded">
    ...
    <button onclick="window.location='/opiekun/mojezgloszenia'" id="archivebutton" type="button" class="btn btn-success">
        <i class="bi bi-archive"></i> Aktualne
    </button>
    <c:if test="${reportSystemList != []}" >
        <table class="table table-borderless table-responsive card-1 p-4">
            <thead><tr class="border-bottom">
                <th colspan="5"><center><h1 style="color:#FFE8E8;">Lista Zgłoszeń Sal Opiekuna - archiwalne</h1></center></th>
